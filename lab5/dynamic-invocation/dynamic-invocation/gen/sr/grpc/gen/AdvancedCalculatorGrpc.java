...
public final class AdvancedCalculatorGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<sr.grpc.gen.PrimeCheckerInput,
      sr.grpc.gen.PrimeCheckerResult> getPrimeCheckerMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "PrimeChecker",
      requestType = sr.grpc.gen.PrimeCheckerInput.class,
      responseType = sr.grpc.gen.PrimeCheckerResult.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<sr.grpc.gen.PrimeCheckerInput,
      sr.grpc.gen.PrimeCheckerResult> getPrimeCheckerMethod() {
    io.grpc.MethodDescriptor<sr.grpc.gen.PrimeCheckerInput, sr.grpc.gen.PrimeCheckerResult> getPrimeCheckerMethod;
    if ((getPrimeCheckerMethod = AdvancedCalculatorGrpc.getPrimeCheckerMethod) == null) {
      synchronized (AdvancedCalculatorGrpc.class) {
        if ((getPrimeCheckerMethod = AdvancedCalculatorGrpc.getPrimeCheckerMethod) == null) {
          AdvancedCalculatorGrpc.getPrimeCheckerMethod = getPrimeCheckerMethod =
              io.grpc.MethodDescriptor.<sr.grpc.gen.PrimeCheckerInput, sr.grpc.gen.PrimeCheckerResult>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "PrimeChecker"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  sr.grpc.gen.PrimeCheckerInput.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  sr.grpc.gen.PrimeCheckerResult.getDefaultInstance()))
              .setSchemaDescriptor(new AdvancedCalculatorMethodDescriptorSupplier("PrimeChecker"))
              .build();
        }
      }
    }
    return getPrimeCheckerMethod;
  }
  ...
  public static abstract class AdvancedCalculatorImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void primeChecker(sr.grpc.gen.PrimeCheckerInput request,
        io.grpc.stub.StreamObserver<sr.grpc.gen.PrimeCheckerResult> responseObserver) {
      asyncUnimplementedUnaryCall(getPrimeCheckerMethod(), responseObserver);
    }
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            getPrimeCheckerMethod(),
            asyncUnaryCall(
              new MethodHandlers<
                sr.grpc.gen.PrimeCheckerInput,
                sr.grpc.gen.PrimeCheckerResult>(
                  this, METHODID_PRIME_CHECKER)))
          .build();
    }
  }
  ...
  public static final class AdvancedCalculatorStub extends io.grpc.stub.AbstractAsyncStub<AdvancedCalculatorStub> {
    ...
    public void primeChecker(sr.grpc.gen.PrimeCheckerInput request,
        io.grpc.stub.StreamObserver<sr.grpc.gen.PrimeCheckerResult> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(getPrimeCheckerMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class AdvancedCalculatorBlockingStub extends io.grpc.stub.AbstractBlockingStub<AdvancedCalculatorBlockingStub> {
    ...
    /**
     */
    public sr.grpc.gen.PrimeCheckerResult primeChecker(sr.grpc.gen.PrimeCheckerInput request) {
      return blockingUnaryCall(
          getChannel(), getPrimeCheckerMethod(), getCallOptions(), request);
    }
  }
  ...
  public static final class AdvancedCalculatorFutureStub extends io.grpc.stub.AbstractFutureStub<AdvancedCalculatorFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<sr.grpc.gen.PrimeCheckerResult> primeChecker(
        sr.grpc.gen.PrimeCheckerInput request) {
      return futureUnaryCall(
          getChannel().newCall(getPrimeCheckerMethod(), getCallOptions()), request);
    }
  }

  private static final int METHODID_COMPLEX_OPERATION = 0;
  private static final int METHODID_PRIME_CHECKER = 1;
      ...
      switch (methodId) {
        case METHODID_COMPLEX_OPERATION:
          serviceImpl.complexOperation((sr.grpc.gen.ComplexArithmeticOpArguments) request,
              (io.grpc.stub.StreamObserver<sr.grpc.gen.ComplexArithmeticOpResult>) responseObserver);
          break;
        case METHODID_PRIME_CHECKER:
          serviceImpl.primeChecker((sr.grpc.gen.PrimeCheckerInput) request,
              (io.grpc.stub.StreamObserver<sr.grpc.gen.PrimeCheckerResult>) responseObserver);
          break;
        default:
      ...
      synchronized (AdvancedCalculatorGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getPrimeCheckerMethod())
              .build();
        }
      }
    }
